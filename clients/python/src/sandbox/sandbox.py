...
class Sandbox:
    ...
    """
    _HINT_AUTH_PERMISSION = " (Hint: Permission denied or missing authentication. Ensure you have enabled 'use_google_auth=True' and that your account has the 'Cloud Run Invoker' (roles/run.invoker) role on this service.)"
